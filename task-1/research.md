# Task 1 — Competitor Research and Gap Analysis

## Section A — Technology Comparison Table

| Platform       | Core Technology                  | Assessment Method                                                                 | AI Depth                                                                 | Follow-Through                                                                 | Language Support                  |
|----------------|----------------------------------|-----------------------------------------------------------------------------------|--------------------------------------------------------------------------|--------------------------------------------------------------------------------|-----------------------------------|
| iDreamCareer  | Psychometric engine + counselor management | Aptitude, personality, interest test (16 factors) mapped to 21 career clusters; ~20-90 MCQ quiz, 20 min | Low — Rule-based psychometrics; AI mainly for automated 16-page report generation [page:0][web:7] | Counselor-led sessions, personalized roadmaps, mentor chats via dashboard     | English, Hindi, 7+ regional (e.g., Marathi, Kannada) [page:0][web:7] |
| Mindler       | 5D psychometric + ML algorithms + Nexus/Orion | 5D test (interests, personality, aptitude/EQ/orientation); ~2.5 hrs, 37-page report w/ 56 parameters [web:36][web:32] | Medium-High — Nexus for ML recs; Orion 24/7 AI chatbot + simulations, hybrid w/ human coaches [web:30][web:37] | 1-year AI dashboard, counselor sessions, action plans, virtual internships   | English, Hindi; Tamil/Telugu planned [web:36][web:32] |
| CareerGuide.com | AI-based psychometrics + ML roadmaps | 30+ tests (stream, skill, personality, domain-specific); online quizzes           | Medium — ML for roadmaps/matching; form-based delivery                    | Counselor connections post-report; limited long-term tracking                 | Primarily English |
| Edumilestones | CCPA + white-label counselor platform | Psychometric (interests, personality, aptitude); comprehensive online assessment | Low — AI for matching/recs; assessment-driven                             | Network of 4200+ counselors; no automated long-term follow-up                 | English + some regional |
| CareerNaksha  | ML psychometrics + O*NET mapping | 5D test (personality, behavior, aptitude, skills, work styles)                    | Low-Medium — ML career matching; human counselor delivery                 | Online/offline counselors in 40+ cities                                       | Regional via counselors |
| 80,000 Hours  | Research-driven framework       | Self-directed guides/reflection (no formal test)                                  | Low — No AI; content/research only                                        | None; self-serve resources only                                               | English only |

---

## Section B — The Five Core Gaps
...
Every platform delivers a report and then disappears. The student is left alone to figure out what to do with a 30-page PDF, which colleges to apply to, which entrance exams matter, and what to do if their first choice falls through. 
The guidance ends exactly when the confusion begins. A better system would stay with the student through the admission season — checking in, adjusting the plan when results come out, and helping them act on the recommendation step by step.
...
## Section C — What PathAI Can Deliver
